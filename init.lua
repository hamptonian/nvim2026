...
-- Disable mouse mode (prevents click-to-move-cursor)
vim.o.mouse = ''
...
require('lazy').setup({
  ...
  -- NOTE: which-key is now configured in lua/custom/plugins/which-key.lua
  -- with enhanced keybindings, icons, and positioning. It is lazy loaded
  -- on VeryLazy event for better startup performance.
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      require('telescope').setup {
        defaults = {
          -- Make preview window wider (50/50 split)
          layout_strategy = 'horizontal',
          layout_config = {
            horizontal = {
              preview_width = 0.5, -- 50% of window for preview
              results_width = 0.5, -- 50% of window for results
              height = 0.9, -- Use 90% of available height
              width = 0.95, -- Use 95% of available width
            },
          },
          -- Telescope keybindings: C-d/C-u for preview, C-j/C-k for results
          mappings = {
            i = { -- Insert mode mappings
              ['<Esc>'] = 'close', -- Press Esc once to close
              ['<C-j>'] = 'move_selection_next', -- Move down in results
              ['<C-k>'] = 'move_selection_previous', -- Move up in results
              ['<C-d>'] = 'preview_scrolling_down', -- Half-page down in preview
              ['<C-u>'] = 'preview_scrolling_up', -- Half-page up in preview
              ['<C-n>'] = 'cycle_history_next', -- Next search history
              ['<C-p>'] = 'cycle_history_prev', -- Previous search history
            },
            n = { -- Normal mode mappings
              ['<Esc>'] = 'close', -- Press Esc once to close
              ['j'] = 'move_selection_next', -- Move down in results
              ['k'] = 'move_selection_previous', -- Move up in results
              ['<C-d>'] = 'preview_scrolling_down', -- Half-page down in preview
              ['<C-u>'] = 'preview_scrolling_up', -- Half-page up in preview
            },
          },
      ...
      -- Search group (general searching)
      ...
      vim.keymap.set('n', '<leader>fl', builtin.oldfiles, { desc = '[F]ind [L]atest/Recent Files' })
  ...
  { -- Autocompletion
    ...
    opts = {
      ...
      sources = {
        ...
        -- Minimum characters before triggering completion (default is 0)
